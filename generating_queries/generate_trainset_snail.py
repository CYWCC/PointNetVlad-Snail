...
def split_dataset(base_path, data_split, save_path, positive_dist, negative_dist, use_timestamp_name):
    """
    ...
    for group_id, group in enumerate(tqdm(groups)):
        ...
        for seq in tqdm(seqs):
            ...
            if use_timestamp_name:
                df_locations['data_file'] = data_split + '/' + group + '/' + seq + '/' + df_locations[
                    'timestamp'] + '.bin'
            else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--yaw_threshold', type=float, default=75, help='Yaw angle threshold,3 or 25')
